...
import { ViewBlogData } from "../Coloumn/Coloumn";
...
function ViewBlog() {
  ...
  const handleClickDelete = (key) => {
    axios
      .delete(
        `${process.env.REACT_APP_API_URL}/api/Blog/admin/admindelete/${key}`
      )
      .then(() => fetchData());
  };
  ...
  return (
    <div className="">
      <div className="flex flex-col gap-[20px] px-[20px] py-[20px] overflow-x-scroll scroll">
        <h className="font-bold font-mont text-[22px] sticky left-0 tracking-wider ">View Blog</h>
        ...
        <table {...getTableProps()} className="text-[14px] text-center">
          <thead className="font-mont font-bold">
            {headerGroups.map((headerGroup) => (
              <tr {...headerGroup.getHeaderGroupProps()} className="">
                ...
                <th className="border-[1px] px-[20px]">Action</th>
              </tr>
            ))}
          </thead>
                    ...
                    <div className="flex flex-col gap-[10px] relative">
                      ...
                      {action && select === key && (
                        <div className="flex justify-center  absolute top-[32px] right-[100px]">
                          <div className="bg-white shadow-md px-[10px] py-[10px]  w-[150px] gap-[5px] text-[14px] flex flex-col items-start">
                            ...
                            <div className="flex gap-[10px] items-center">
                              ...
                              <Link
                                to={`/admin/EditBlog/${row.original._id}`}
                                state={{
                                  title: `${row.original.title}`,
                                  discription: `${row.original.content}`,
                                }}
                              >
                                Edit
                              </Link>
          ...
          <tfoot className="font-mont font-bold">
        ...
        <div className="flex flex-col md:flex-row gap-[10px] md:gap-0 items-center justify-between sticky left-0">
          ...
          <div className="flex flex-row items-center gap-[10px]">
            ...
            <button
              ...
              className="bg-[black] w-[60px] h-[20px]  flex justify-center items-center text-[14px] font-semibold text-white"
            >
              PREV
            </button>
            <button
