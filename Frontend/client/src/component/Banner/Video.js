      ...
      <div className="absolute top-60 flex flex-col gap-[30px] items-center  w-full font-mont font-bold">
        ...
        >
          ...
          >
            ...
            <motion.span className="text-[#EF834B]" variants={letterVariants}>V</motion.span>
            <motion.span className="text-[#EF834B]" variants={letterVariants}>i</motion.span>
            <motion.span className="text-[#EF834B]" variants={letterVariants}>d</motion.span>
            <motion.span className="text-[#EF834B]" variants={letterVariants}>e</motion.span>
